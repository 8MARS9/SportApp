...
public class ProductService {
    ...
    private boolean validateProduct(Product product) throws Exception {
        if (product.getName().isEmpty() || product.getName() == null) {throw new Exception ("Please provide name field");}
        if (product.getQuantity() == null) { throw new Exception ("Please provide product quantity"); }
        if (product.getPrice() == null) { throw new Exception ("Please provide product price"); }
        if (product.getDescription().isEmpty() || product.getDescription() == null) { throw new Exception ("Please provide product description"); }
        if (product.getAvailable() == null) { throw new Exception ("Please provide product availability"); }
        return true;
    }
    ...
    /*public Product findProductById() throws Exception {
        throw new ExecutionControl.NotImplementedException("");
    }*/
    public Product findProductById(UUID productId) throws Exception {
        for (Product currentProduct : this.products) {
            // check id and return matching product
